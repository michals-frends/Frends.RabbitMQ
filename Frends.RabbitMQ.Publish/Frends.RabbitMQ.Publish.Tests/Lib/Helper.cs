...
internal class Helper
{
    ...
    internal static void ReadMessageFactory(ReadValues readValues, Connection connection)
    {
        var factory = new ConnectionFactory();
        ...
        var session = RabbitMQ.GetSession(connection);

        IConnection _connection = session.Connection;
        IModel _model = session.Model;
